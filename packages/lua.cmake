...
# Enforce IPO with Intel compiler for Lua interpreter binaries
if(CMAKE_C_COMPILER_ID STREQUAL "IntelLLVM" AND NOT SUPERBUILD_IPO_OPTS)
  set(LUA_IPO_OPTS "/Qipo /Qopt-report:2")
else()
  set(LUA_IPO_OPTS "${SUPERBUILD_IPO_OPTS}")
endif()
ExternalProject_Add(lua
  ...
  "-DCMAKE_C_FLAGS=${SUPERBUILD_C_FLAGS} ${LUA_IPO_OPTS}"
  "-DCMAKE_EXE_LINKER_FLAGS=${SUPERBUILD_EXE_LINKER_FLAGS} ${LUA_IPO_OPTS}"
  "-DCMAKE_SHARED_LINKER_FLAGS=${SUPERBUILD_SHARED_LINKER_FLAGS} ${LUA_IPO_OPTS}"
